...
XIAOMI.namespace = function() {
    ...
    function() {
        ...
        function t(e, n, r) {
            return ("string" == typeof n ? n: n.toString()).replace(e.define || i,
                function(t, n, o, a) {
                    return 0 === n.indexOf("def.") && (n = n.substring(4)),
                        n in r || (":" === o ? (e.defineParams && a.replace(e.defineParams,
                            function(e, t, o) {
                                r[n] = {
                                    arg: t,
                                    text: o
                ...
                function(n, o) {
                    e.useParams && (o = o.replace(e.useParams,
                        function(e, t, n, o) {
                            if (r[n] && r[n].arg && o) {
                                var a = (n + ":" + o).replace(/'|\\/g, "_");
                                return r.__exp = r.__exp || {},
                                    r.__exp[a] = r[n].text.replace(new RegExp("(^|[^\\w$])" + r[n].arg + "([^\\w$])", "g"), "$1" + o + "$2"),
                                    t + "def.__exp['" + a + "']"
                            }
                        }));
        ...
        o.template = function(r, u, c) {
            ...
            var s,
                p,
                l = u.append ? a.append: a.split,
                d = 0,
                f = u.use || u.define ? t(u, r, c || {}) : r;
            f = ("var out='" + (u.strip ? f.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : f).replace(/'|\\/g, "\\$&").replace(u.interpolate || i,
                function(e, t) {
                    return l.start + n(t) + l.end
                }).replace(u.encode || i,
                function(e, t) {
                    return s = !0,
                        l.start + n(t) + l.endencode
                }).replace(u.conditional || i,
                function(e, t, r) {
